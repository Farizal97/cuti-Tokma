            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    <li>
                        ...
                        <div class="user-section">
                            <div class="user-section-inner">
                                <img src="img/<?php echo $sess_userfoto;?>" class="img-circle elevation-2" alt="">
                            </div>
                            <div class="user-info">
					...
					if($pagedesc=="Data Karyawan"){
                        ...
                        <a href="karyawan.php"><i class="fa fa-group fa-fw"></i>Data Karyawan</a>
                    </li>
					<?php 
					if($pagedesc=="Data Manager"){
                        ...
                        <a href="manager.php"><i class="fa fa-user fa-fw"></i>Data Manager</a>
                    </li>
					<?php 
					if($pagedesc=="Divisi"){
						echo "<li class='selected'>";
                        ...
                        <a href="divisi.php"><i class="fa fa-link fa-fw"></i>Divisi</a>
                    </li>
					<?php 
						if($pagedesc=="Menunggu Approval"||$pagedesc=="Approved"||$pagedesc=="Semua Data Cuti"){
							echo "<li class='active'>";
						}else{
							echo "<li>";
						}?>							
                        <a href="#"><i class="fa fa-random fa-fw"></i>Approval<span class="fa arrow"></span></a>
					...
					if($pagedesc=="Laporan"){
                        ...
                        <a href="laporan.php"><i class="fa fa-folder fa-fw"></i>Laporan</a>
                    </li>
                </ul>
                <!-- end side-menu -->
            </div>
