...
if(isset($_POST['simpan'])) {
	...
	if($durasi>$jml){
		...
		$sql 	= "INSERT INTO cuti (cuti_id, kry_nip, cuti_tgl, cuti_mulai, cuti_akhir, cuti_durasi, cuti_ket, cuti_stt, cuti_reject) 
					VALUES ('$id','$nip','$ajuan','$mulai','$akhir','$durasi','$ket','$stt','$null')";
