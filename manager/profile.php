...
include "layout_top.php";
 ...
 $sql = "SELECT * FROM manager WHERE mng_nip='$sess_mngid'";
		...
		<div class="col-lg-12">
			<form class="form-horizontal" action="profile_act.php" method="POST" enctype="multipart/form-data">
				<div class="panel panel-default">
					...
					<br/>
					<center><img src="../img/<?php echo $data['mng_foto'];?>" width="150px"></center>
					<br/>
					<div class="panel-body">
						<div class="form-group">
							<label class="control-label col-sm-3">Nama User</label>
							<div class="col-sm-6">
								<input type="text" name="nama" class="form-control" value="<?php echo $data['mng_nama'] ?>" required>
								<input type="hidden" name="id" value="<?php echo $data['mng_nip'] ?>">
							</div>
						</div>
						<div class="form-group">
