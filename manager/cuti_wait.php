                 ...
                 <div class="table-responsive">
					<table class="table table-striped table-bordered table-hover" id="dataTables-example">
						<thead>
						 ...
						 <?php
							$i = 1;
							$sql = "SELECT cuti.*, karyawan.* FROM cuti, karyawan WHERE cuti.kry_nip=karyawan.kry_nip AND cuti.cuti_stt='Menunggu Approval Manager' ORDER BY cuti.cuti_tgl DESC";
							...
							echo '<td class="text-center">
								  ...
								  <a href="cuti_review.php?cut='. $data['cuti_id'] .'" class="btn btn-warning btn-circle btn-sm"><i class="fa fa-edit"></i></a></td>';
							echo '</tr>';
							$i++;
							}
							?>
