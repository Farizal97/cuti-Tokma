        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    <li>
                        ...
                        <div class="user-section">
                            <div class="user-section-inner">
                                <img src="../img/<?php echo $sess_mfoto;?>" class="img-circle elevation-2" alt="">
                            </div>
                            <div class="user-info">
					...
					<?php 
						if($pagedesc=="Menunggu Approval"||$pagedesc=="Semua Data Cuti"){
							echo "<li class='active'>";
						}else{
							echo "<li>";
						}?>							
                        <a href="#"><i class="fa fa-check-square fa-fw"></i>Approval Cuti<span class="fa arrow"></span></a>
